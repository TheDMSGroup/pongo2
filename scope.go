...
// returns false.
func (s Scope) Range(fn func(key string, value interface{}) bool) {
...
// bypass them by indexing a map directly. The user map is used directly and is
// never copied.
...
func (p PublicContext) Get(key string) (interface{}, bool) {
...
func (p PublicContext) Range(fn func(key string, value interface{}) bool) {
